...
class inverse_lengths:
    def __init__(self,i_model,list_pa):
    ...
    def inv_L_inte(self):
        ...
        return csr_matrix( np.diag(inv_L) )# here divide with the A for sun instead of 1.2!!! I dont know about this!!!!!
    ...
    def inv_L_dec(self):
        ...
        return csr_matrix(np.diag(inv_L_dec))
